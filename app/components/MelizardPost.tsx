...
export default function MelizardPost({post, showEdit, className=''}: Props){
    return(
        <div className={`bg-gray-600 mb-10 py-3 rounded-md w-full max-w-md ${className}`} key={post.id}>
