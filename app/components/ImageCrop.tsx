...
export default function ImageCrop ({ visible, image, onClose, onCrop }: ImageCropProps) {
  ...
  return (
    <div className={`${!visible ? 'hidden' : ''} h-[50vh] relative`}>
        <button onClick={onClose} className="hover:bg-gray-400 rounded-full z-10 absolute top-0 right-0">
